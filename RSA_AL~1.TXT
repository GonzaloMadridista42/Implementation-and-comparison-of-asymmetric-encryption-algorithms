...
if __name__ == '__main__':
    # Code block that measures the algorithmic complexity of the keys generated and the encryption and decryption process provided by the Python code implementing the RSA algorithm 
    ...
    encrypted_time = measure_encryption(123456, public_key)
    ...
    print("Encryption time:", encrypted_time_str, "seconds")
    ...
    decrypted_time = measure_decryption(encrypted_time, private_key)
    ...
    print("Decryption time:", decrypted_time_str, "seconds")
