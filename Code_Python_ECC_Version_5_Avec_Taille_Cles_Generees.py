...
if __name__ == '__main__':
    # Code block that measures the size of the keys generated by the ECC algorithm 
    ...
    # Extract private key value and calculate its size in bits
    private_key_value = private_key.private_numbers().private_value
    private_key_size = math.log(private_key_value, 2)

    # Extract public key value and calculate its size in bits
    public_key_value = public_key.public_numbers().x
    public_key_size = math.log(public_key_value, 2)

    print("\nThe generated public key (size in bits):")
    print(public_key_value, "(", public_key_size, "bits)")
    print("\nThe generated private key (size in bits):")
    print(private_key_value, "(", private_key_size, "bits)")