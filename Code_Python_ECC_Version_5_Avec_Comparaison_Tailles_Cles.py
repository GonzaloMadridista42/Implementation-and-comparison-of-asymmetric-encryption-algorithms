...
if __name__ == '__main__':
    # Code block that measures the size (length) of the keys generated by the ECC encryption and decryption algorithm, that allows to compare the size of those keys generated by the ECC algorithm
    ...
    if 'private_key' in globals() and 'public_key' in globals():
        # Print key sizes
        print("\nSize of the public key:", public_key_size, "bits")
        print("Size of the private key:", private_key_size, "bits")
        ...
        encrypt_key_gen_time, encrypt_key_gen_memory = measure_key_generation(user_response_elliptic_curve)
        ...
        decrypt_key_gen_time, decrypt_key_gen_memory = measure_key_generation(user_response_elliptic_curve)
