...
if __name__ == '__main__':
    # Code block that measures the algorithmic complexity of the keys generated and the encryption and decryption process provided by the Python code implementing the El-Gamal algorithm 
    ...
    if 'g' in globals() and 'key' in globals():
        ...
        key_gen_memory = get_memory_usage()
    ...
    encryption_time_str = "{:.8f}".format(max(0.00000001, encryption_time))
    print("Encryption time:", encryption_time_str, "seconds")
    ...
    decryption_time_str = "{:.8f}".format(max(0.00000001, decryption_time))
    print("Decryption time:", decryption_time_str, "seconds")
