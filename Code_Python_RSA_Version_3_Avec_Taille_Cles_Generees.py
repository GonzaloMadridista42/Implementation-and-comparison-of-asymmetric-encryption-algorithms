...
if __name__ == '__main__':
    ...
    public_key_size = math.log2(public_key[1])
    private_key_size = math.log2(private_key[1])

    print("\nThe generated public key (size in bits):")
    print(public_key, "(", 8*public_key_size, "bits)")
    print("\nThe generated private key (size in bits):")
    print(private_key, "(", 8*private_key_size, "bits)")